 ...
 */
package main.java.ai.djl.nn.convolutional;
 ...
 *
 * <p>The input to a {@code Conv1dTranspose} is an {@link NDList} with a single 3-D
 * {@link NDArray}. The layout of the {@link NDArray} must be "NCW".
 * The shapes are
 *
 * <ul>
