 ...
 */
package main.java.ai.djl.training.dataset;
...
public abstract class RandomAccessDataset implements Dataset {
    ...
    public abstract static class BaseBuilder<T extends BaseBuilder<T>> {
        ...
        /**
         * Sets the {@link Pipeline} of {@link Transform} to be applied on the
         * data.
         *
         * @param pipeline the {@link Pipeline} of {@link Transform} to be applied
         *     on the data
         * @return this {@code BaseBuilder}
         */
         ...
         * labels.
         *
         * @param targetPipeline the {@link Pipeline} of {@link Transform} to be
