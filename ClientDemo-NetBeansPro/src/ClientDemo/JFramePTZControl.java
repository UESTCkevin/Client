...
public class JFramePTZControl extends javax.swing.JFrame
{
     ...
     *************************************************/
    public JFramePTZControl(NativeLong luserID,NativeLong lChannel,NativeLong lRealHandle)
    {
    ...
    private void initComponents() {
        ...
        jButtonPicStop = new javax.swing.JButton();
        jButtonPicStart = new javax.swing.JButton();
        jButtonPicSettings = new javax.swing.JButton();
        jTextFieldCircleTime = new javax.swing.JTextField();
        jTextFieldPauseTime = new javax.swing.JTextField();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("轮巡路径"));
...
//        );
         ...
         */
        jLabel10.setText("分钟");
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("自动轮巡"));
        jButtonPicStart.setText("开始");
        jButtonPicStart.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        //TODO 自动拍照开始事件处理
        jButtonPicStart.addActionListener(new java.awt.event.ActionListener() {

            @Override
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    jButtonPicStartActionPerformed(evt);
        ...
        jButtonPicSettings.setText("设置");
        jButtonPicSettings.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jButtonPicSettings.addActionListener(new java.awt.event.ActionListener(){

            @Override
            public void actionPerformed(java.awt.event.ActionEvent evt){
                try {
                    jButtonPicSettingsActionPerformed(evt);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            }
        ...
        jButtonPicStop.setText("停止");
        jButtonPicStop.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        //TODO 自动拍照停止事件处理
        jButtonPicStop.addActionListener(new java.awt.event.ActionListener(){

            @Override
            public void actionPerformed(java.awt.event.ActionEvent evt){
                try {
                    jButtonPicStopActionPerformed(evt);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
            }
...
//                                .addComponent(jTextFieldCircleTime, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
//                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
//                                .addComponent(jLabel10, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
//                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                                .addComponent(jButtonPicStart)
//                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                                .addComponent(jButtonPicStop))
//        );
//        jPanel4Layout.setVerticalGroup(
//                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
//                        .addGroup(jPanel4Layout.createSequentialGroup()
//                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
//                                        .addComponent(jTextFieldCircleTime, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
//                                        .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
//                                        .addComponent(jButtonPicStart, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
//                                        .addComponent(jButtonPicStop, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
//                                .addContainerGap())
//
//        );
                ...
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel4Layout.createSequentialGroup()
                                                .addComponent(jButtonPicStart, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(10, 10, 10)
                                                .addComponent(jButtonPicSettings, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(10, 10, 10)
                                                .addComponent(jButtonPicStop, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
        )));
        jPanel4Layout.setVerticalGroup(
                jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jButtonPicStart, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jButtonPicSettings, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jButtonPicStop, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
        )));
...
//                .addContainerGap())
    ...
    private void jButtonGotoPresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGotoPresetActionPerformed
        ...
        {
            System.out.println("错误码：" + hCNetSDK.NET_DVR_GetLastError());
    ...
    private void jButtonGotoSeqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGotoSeqActionPerformed
        ...
        if (!m_bIsOnCruise)
        {
            ...
            {
                JOptionPane.showMessageDialog(this, "调用轮巡失败");
                return;
            }
        }
    ...
    /*************************************************
    函数:       轮巡路径  "设置"按钮  双击响应函数
    函数描述:	设置轮巡路径
     *************************************************/
    private void jButtonSetSeqActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_jButtonSetSeqActionPerformed
        ...
        public void run() {
            while (!picDone) {
                try {
                    ...
                    int picTime = JDialogPTZCruiseTimeSettings.picTime;
                    int circleTime = JDialogPTZCruiseTimeSettings.circleTime;
                    int pauseTime = JDialogPTZCruiseTimeSettings.pauseTime;
                    Date date = new Date();
                    SimpleDateFormat df1 = new SimpleDateFormat("yyyyMMddHHmmss");
                    File file = new File("E:\\Pic\\" + df1.format(date));
                    if (!file.exists()) {
                        file.mkdir();
                    }
                    String fileName = "";
                    long createTime = System.currentTimeMillis();
                    for(int i : JDialogPTZCruise.cruiseRoute.get(jComboBoxSeq.getSelectedIndex() + 1)){
                        hCNetSDK.NET_DVR_PTZPreset(m_lRealHandle, HCNetSDK.GOTO_PRESET, i);
                        TimeUnit.SECONDS.sleep(pauseTime);
                        if(jComboBoxSeq.getSelectedIndex() + 1 == 1){
                            switch(i){
                                case 1 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_刹车盘_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 2:
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_齿轮箱螺栓后_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 3 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_齿轮箱螺栓前_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 4 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_接油盒_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 5 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_齿轮箱表面_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 6 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_过滤器接头_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 7 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_安全标识1_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 8 :
                                    fileName = file.getAbsolutePath() + "\\" + "01机组_安全标识2_正常_" + df1.format(date) + ".jpg";
                                    break;
                            }
                        }
                        else if(jComboBoxSeq.getSelectedIndex() + 1 == 2){
                            switch(i){
                                case 1 :
                                    fileName = file.getAbsolutePath() + "\\" + "02机组_刹车盘保护壳_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 2 :
                                    fileName = file.getAbsolutePath() + "\\" + "02机组_过滤器_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 3 :
                                    fileName = file.getAbsolutePath() + "\\" + "02机组_发电机螺栓_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 4 :
                                    fileName = file.getAbsolutePath() + "\\" + "02机组_油管接头_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 5 :
                                    fileName = file.getAbsolutePath() + "\\" + "02机组_安全标识3_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 6 :
                                    fileName = file.getAbsolutePath() + "\\" + "02机组_烟雾视角1_正常_" + df1.format(date) + ".jpg";
                                    break;
                            }
                        }
                        else if(jComboBoxSeq.getSelectedIndex() + 1 == 3){
                            switch(3){
                                case 1 :
                                    fileName = file.getAbsolutePath() + "\\" + "03机组_马盘_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 2 :
                                    fileName = file.getAbsolutePath() + "\\" + "03机组_主轴承螺栓_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 3 :
                                    fileName = file.getAbsolutePath() + "\\" + "03机组_烟雾视角2_正常_" + df1.format(date) + ".jpg";
                                    break;
                                case 4 :
                                    fileName = file.getAbsolutePath() + "\\" + "03机组_散热器油管_正常_" + df1.format(date) + ".jpg";
                                    break;
                            }
                        }
                        fileName = new String(fileName.getBytes("utf-8"),"ISO8859-1");
                        hCNetSDK.NET_DVR_CaptureJPEGPicture(userID, channel, jpeg, fileName);
                    }
                    Thread.sleep(1000 * 60 * circleTime);
                    long currentTime = System.currentTimeMillis();
                    if ((currentTime - createTime) / 1000 / 60 / 60 >= picTime)
                        picDone = true;
    ...
    /*************************************************
     函数:       自动轮巡  "开始"按钮  双击响应函数
     函数描述:	开始自动拍图
     *************************************************/
    private void jButtonPicStartActionPerformed(java.awt.event.ActionEvent evt) throws InterruptedException {
        picDone = false;
    ...
    /*************************************************
     函数:       自动轮巡  "设置"按钮  双击响应函数
     函数描述:	设置自动拍图参数
     *************************************************/
    private void jButtonPicSettingsActionPerformed(java.awt.event.ActionEvent evt) throws InterruptedException {
        JDialogPTZCruiseTimeSettings jDialogPTZCruiseTimeSettings = new JDialogPTZCruiseTimeSettings(this, true);
        jDialogPTZCruiseTimeSettings.setBounds(this.getX(), this.getY(), 350, 240);
        jDialogPTZCruiseTimeSettings.setVisible(true);
    }

    /*************************************************
     函数:       自动轮巡  "停止"按钮  双击响应函数
     函数描述:	停止自动拍图
     *************************************************/
    private void jButtonPicStopActionPerformed(java.awt.event.ActionEvent evt) throws InterruptedException {
        picDone = true;
    }
     ...
     * 自加组件
     */
    private javax.swing.JButton jButtonPicStart;
    private javax.swing.JButton jButtonPicSettings;
    private javax.swing.JButton jButtonPicStop;
    private javax.swing.JPanel jPanel4;
    private javax.swing.JTextField jTextFieldCircleTime;
    private javax.swing.JTextField jTextFieldPauseTime;
