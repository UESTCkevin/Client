...
public class ClientDemo extends javax.swing.JFrame
{
    ...
    public NativeLong getChannel(){
        ...
        return m_strClientInfo.lChannel;
    }
    ...
    private void initComponents() {
        ...
        jPasswordFieldPassword.setText("momishijue505");
      ...
      System.out.println(panelRealplay.getHeight());
        ...
        if (bRealPlay == false)
        {
            ...
            else if(jComboBoxCallback.getSelectedIndex() == 1)
            {
                ...
                File file = new File("E:\\" + df1.format(date));
                if (!file.exists()) {
                    file.mkdir();
                }
                ...
                if (!hCNetSDK.NET_DVR_SaveRealData(lPreviewHandle, file.getAbsolutePath() + "\\" + df2.format(date) + ".mp4")) {
            ...
            //显示云台控制窗口
            framePTZControl = new JFramePTZControl(getlUserID(),getChannel(),lPreviewHandle);
  ...
  /*************************************************
    ...
    {//GEN-HEADEREND:event_jMenuItemDeviceStateMousePressed
        ...
        //打开JDialog
        JDialogDeviceState dlgDeviceState = new JDialogDeviceState(this, false, lUserID, m_strDeviceInfo, m_sDeviceIP,jComboBoxCallback.getSelectedIndex());
